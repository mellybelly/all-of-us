...
The communications peer-index narrative (ELSI 26.3×, SDOH 5.1×, PGx 4.6×,
...
AoU is at 6.0% post-2023 in aging/ADRD (≈peer median, growing) while UKB/MVP/CKB grow faster in
...
|---|---:|---:|---:|---|
| ELSI / participant engagement | 4.9% | 0.2% | **26.3×** | NHGRI A4; NIH-Wide CCT5 |
| SDOH / disparities | 32.9% | 6.5% | **5.1×** | NIMHD G7 (literal mandate); NIH-Wide CCT1 |
| Pharmacogenomics | 2.4% | 0.5% | **4.6×** | NIGMS-G4 (PGRN); NCATS Translator |
...
- **Multi-omics beyond genomics.** 24 pubs / 1.7% share vs UKB 12.2%
...
- **Dermatology at 13.9% / peer-index 6.9×.** Driven by 1–2 prolific
  groups; declining as a share (trend −4.4); not a strategic priority.
...
|---|---|---|
| AI / LLM / foundation models | Already realized — HA4 33 pubs, 30 post-2023 | AI need area; Refresh via 9th FA |
| Breakthrough therapeutics (GLP-1, SGLT2, AD mAbs, CRISPR) | Already realized — HA8 20 pubs | Translational need area (use case) |
| Wearables / remote monitoring | Already realized but **trend-flat** — HA2 75 pubs, ±0.0; **recognition gap, not growth gap** | Refresh need area via 9th FA |
...
| G×E×SDOH integrated holistic risk models | **Emerging, AoU positioned to lead** — HA6 11 pubs, 0 pre-2023 | Refresh need area as latent strength; translational use case |
...
| Environmental health | **Largest gap with named IC demand** — HA5 13 pubs; NIEHS 6 priorities | Refresh need area, framework commitment via FA6 |
...
- **WG-1 Rec 3 (FA2/FA4/FA6 reframes).** FA4 is well-evidenced (−9.8
