...
Inputs: 1,374 substantive publications from the AoU corpus, tagged with the
...
fact that the corpus itself grew ~7.8× from pre-2023 to post-2023.
...
- Year-by-year: 2015 (4); 2016 (4); 2017 (3); 2018 (12); 2019 (13); 2020 (10);
  2021 (32); 2022 (79); 2023 (157); 2024 (341); 2025 (519); 2026 (199);
...
|---|---|---:|---:|---:|---:|---:|
| 2 | Genomics methods & complex-trait genetics | 16 | 331 | 10.2% | 27.2% | **+17.0** |
| 4 | Mental health, behavioral & substance use | 14 | 240 | 8.9% | 19.7% | **+10.8** |
| 1 | Cardiometabolic disease | 30 | 352 | 19.1% | 28.9% | **+9.8** |
| 5 | Cancer | 7 | 169 | 4.5% | 13.9% | **+9.4** |
| 9 | Autoimmune & inflammatory disease | 4 | 103 | 2.6% | 8.5% | **+5.9** |
| 11 | Aging, frailty & ADRD | 2 | 73 | 1.3% | 6.0% | **+4.7** |
| 14 | Neurology (non-ADRD) | 3 | 74 | 1.9% | 6.1% | **+4.2** |
| 13 | Respiratory & sleep medicine | 1 | 58 | 0.6% | 4.8% | **+4.1** |
| 3 | Methods, infrastructure & phenotyping (non-genomic) | 23 | 228 | 14.6% | 18.7% | **+4.1** |
| 6 | Social determinants & health disparities | 48 | 410 | 30.6% | 33.7% | +3.1 |
| 15 | Pregnancy, maternal & women's health | 1 | 36 | 0.6% | 3.0% | +2.3 |
| 18 | Ophthalmology, ENT & sensory medicine | 10 | 97 | 6.4% | 8.0% | +1.6 |
| 10 | Rare disease & Mendelian genetics | 4 | 50 | 2.6% | 4.1% | +1.6 |
| 7 | Wearables & digital health | 7 | 66 | 4.5% | 5.4% | +1.0 |
| 19 | Environmental health & climate | 0 | 7 | 0.0% | 0.6% | +0.6 |
| 16 | Pharmacogenomics & drug response | 3 | 29 | 1.9% | 2.4% | +0.5 |
| 8 | Infectious disease & immunology | 12 | 67 | 7.6% | 5.5% | **−2.1** |
| 12 | Dermatology | 28 | 169 | 17.8% | 13.9% | **−3.9** |
| 17 | ELSI, participant engagement & recruitment | 25 | 44 | 15.9% | 3.6% | **−12.3** |
...
- **Mental health (+10.8), Cancer (+9.4), Cardiometabolic (+9.8)** all
  ...
  scaled-up cohort.
- **AI/Methods (+4.1)** grows moderately as a theme share but the
...
- **Dermatology (−3.9)** declines as relative emphasis — the early
  publication groups that drove the anomalous dermatology share have not
  scaled with the broader corpus.
- **ELSI / engagement (−12.3)** is the biggest decline by far. Pre-2023 the
...
|---|---|---:|---:|---:|---:|---:|
| FA8 | Genetics & Biology | 47 | 686 | 29.9% | 56.4% | **+26.4** |
| FA1 | Prevalent Common & Rare Conditions | 83 | 925 | 52.9% | 76.0% | **+23.1** |
| FA5 | Lifestyle, Substance, & Behavioral Health | 14 | 240 | 8.9% | 19.7% | **+10.8** |
| FA3 | Healthy Aging & Resilience | 2 | 73 | 1.3% | 6.0% | **+4.7** |
| FA2 | Maternal & Child Health | 1 | 36 | 0.6% | 3.0% | +2.3 |
| FA6 | Environment | 0 | 7 | 0.0% | 0.6% | +0.6 |
| FA7 | Health Equity | 87 | 615 | 55.4% | 50.5% | **−4.9** |
| FA4 | Return of Results | 31 | 123 | 19.7% | 10.1% | **−9.6** |
...
- **FA7 Health Equity declines as a share (−4.9)** but in absolute terms
  ...
  "declining priority."
- **FA4 Return of Results declines as a share (−9.6)**, driven by the
...
- **FA6 Environment has essentially no pre-2023 pubs and 7 post-2023 pubs.**
  ...
  detector finds 12 pubs but most of those are SDOH-environment hybrids,
...
**HA2 Wearables / remote monitoring — 70 pubs, FLAT trend.** A real and
substantial area that is *already mature*: 70 pubs detected with title/
...
**HA4 AI / foundation models / LLMs — 31 pubs.** A real and growing
signal, 28 post-2023 of 31 total. Top admin ICs: NHLBI (6), OD (5), NIGMS
...
overall theme-3 growth (+4.1 trend, 228 post-2023 pubs), the AI/Methods
...
**HA5 Environmental health — 12 pubs.** Matches the theme-19 signal closely.
...
**HA6 G × E × SDOH integrated — 10 pubs, borderline thin.** Slide 7's
...
PRS + neighborhood ADI + EHR-derived comorbidity — and the 10 pubs show
...
**HA8 Breakthrough therapeutics — 16 pubs.** Real-world studies of GLP-1
...
**The single biggest change since 2023 is the volume explosion (~7.8×
...
priorities, the evidence is mixed: **AI/foundation models (HA4, 31 pubs)
and breakthrough therapeutics (HA8, 16 pubs, GLP-1/SGLT2/AD mAbs/CRISPR)
are real and growing**; wearables (HA2, 70 pubs) are *already mature* and
trend-flat, not "emerging"; **multi-omics beyond genomics (HA1, 24 pubs),
G × E × SDOH integrated holistic risk models (HA6, 10 pubs), nutrition
...
ELSI / engagement decline (−12.3) is a maturation signal, not a problem;
...
- **AI / foundation models / LLMs** (HA4, +0.4 absolute share but 28 of
  31 pubs are post-2023, 10× absolute growth). Theme 3's broader AI/Methods
  growth (+4.1) backs this. Real and growing.
...
- **Nutrition & microbiome** (HA7, 11 pubs, borderline thin). No stool
  ...
  cohort today.
- **Environmental health** (theme 19, 7 pubs; HA5, 12 pubs). Among the
...
- **Health Equity** (FA7, −4.9 as share; 615 post-2023 pubs absolute).
  Diluted but still load-bearing. Worth protecting as cross-cutting
  emphasis in the Refresh.
- **Return of Results** (FA4, −9.6 as share). Maturation of the corpus
